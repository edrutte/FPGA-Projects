...
# Buttons
set_property -dict {PACKAGE_PIN C1 IOSTANDARD LVCMOS33} [get_ports {btn}]
...
set_property -dict {PACKAGE_PIN H5 IOSTANDARD LVCMOS33} [get_ports {tx_out}]
set_property -dict {PACKAGE_PIN H1 IOSTANDARD LVCMOS33} [get_ports {rx_in}]
...
#set_property -dict {PACKAGE_PIN E11 IOSTANDARD LVCMOS33} [get_ports {tx_out}]
#set_property -dict {PACKAGE_PIN N11 IOSTANDARD LVCMOS33} [get_ports {rx_in}]
#set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports {ftdi_bdbus[2]}]
#set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports {cts}]
