...
set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports {ap_clk}]
#set_property -dict {PACKAGE_PIN B5 IOSTANDARD LVCMOS33} [get_ports {ext_clk}]

create_clock -add -name sys_clk_pin -period 20.00 -waveform {0 10} [get_ports {ap_clk}]

# on-board user LEDs
set_property -dict {PACKAGE_PIN M1 IOSTANDARD LVCMOS33} [get_ports {ap_done}]
...
# Buttons
set_property -dict {PACKAGE_PIN C1 IOSTANDARD LVCMOS33} [get_ports {start}]
set_property -dict {PACKAGE_PIN D1 IOSTANDARD LVCMOS33} [get_ports {ap_rst}]
#set_property -dict {PACKAGE_PIN L2 IOSTANDARD LVCMOS33} [get_ports {nextsig}]
